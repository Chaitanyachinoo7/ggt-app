...
from ggt.models.data_models.schedules import reject_certificate_v2, get_patient_by_id, get_patient_by_id_v2, \
    lookup_certificate, lookup_certificate_v2, vax_yes_activity, vax_yes_activity_v2, \
    get_slots_matching_dt_list, get_slots_matching_dt_list_v2, \
...
class SchedulesSQLTests(unittest.TestCase):
    ...
    def test_reject_certificate(self):
        result = reject_certificate_v2([938669])
    ...
    def test_lookup_certificate(self):
        ...
        result_2 = lookup_certificate_v2("", "", "Donald", "")
    ...
    def test_vax_yes_activity(self):
        ...
        result_2 = vax_yes_activity_v2(939004, "")

        print(result)
        self.assertEqual(result, result_2)

        result = vax_yes_activity("", "143723090141")
        result_2 = vax_yes_activity_v2("", "143723090141")
    ...
    def test_get_slots_matching_dt_list(self):
        ...
        result_2 = get_slots_matching_dt_list_v2(['2020-11-19 09:16:00'], 222, '')
        ...
        result_2 = get_slots_matching_dt_list_v2(['2020-11-19 09:16:00', '2020-11-19 09:00:00'], 222, '')
