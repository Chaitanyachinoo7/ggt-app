...
@router.post("/update_appointment", dependencies=[Security(authorize_user, scopes=[p.ANONYMOUS])])
...
@router.post("/scan_label", dependencies=[Security(authorize_user, scopes=[p.ANONYMOUS])])
