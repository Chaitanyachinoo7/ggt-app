...
from ggt.models.workflow_models.reporting_flow import get_stats_today, get_stats_by_date, get_sms_stats_by_date, \
    get_email_stats_by_date, aging_samples_with_lab, get_user_activity, get_patient_drilldown_by_date
...
@router.post("/get_patient_drilldown_by_date", dependencies=[Security(authorize_user, scopes=[p.ANONYMOUS])])
async def api_patient_drilldown_by_date(patient_drilldown_request: PatientDrilldownRequest):
    return get_patient_drilldown_by_date(patient_drilldown_request)
