...
def get_appointments():
    try:
        ...
        WHERE
            location_id IN (
                2420,370,2422,2424,2385,367,399,2485,361,2414,2446,2419,2447,2415,2423,371,2417,2416,366, 692, 419
            )
            AND scheduled_dt > '2021-01-30 00:00:00'
            AND scheduled_dt < '2021-01-31 00:00:00'
            AND status = 'scheduled'
        """
...
def prepare_sms_text(appointment):
    ...
    return """Hi {}, due to inclement weather the location where you have reigstered for your COVID-19 test will have a delayed start until 2pm. We apologize for the inconvenience. Please visit GoGetTested.com to register for a new appointment.
    """.format(appointment["first_name"])
