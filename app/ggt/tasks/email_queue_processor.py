...
def task_process_email_queue(batch_size=10000, offset=0):
    print('********************BEGIN task_process_email_queue****************************')
    ...
    for i in range(batch_count):
        ...
        __batch_process_email_queue(micro_offset, micro_batch_size)

    print('****************** END ******************************\n\n')


def __batch_process_email_queue(micro_offset, micro_batch_size):
    sql = """
